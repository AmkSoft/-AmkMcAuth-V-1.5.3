...
public class AmkAUtils {
    ...
    public static String getAliasesFor(String Command) {
        String Data = AmkMcAuth.getInstance().getDescription().getCommands().toString();
    	//[13:14:46 INFO]: [AmkMcAuth]
    	//{
		// amkmcauth={description=Provides access to administrative functions of the plugin., usage=/<command> [subcommands|help], aliases=[amka, amkauth]}, 
		// login={description=Logs a player in., usage=/<command> [password], aliases=[l, logon, login]}, 
		// logout={description=Logs a player out., usage=/<command>, aliases=[lo, logoff]}, 
		// register={description=Register a players password or emailaddress., usage=/<command> [password/emailaddress], aliases=[reg, Register]}, 
		// setemail={description=Changes a player's Email-Address., usage=/<command> [emailaddress]},
		// setrecover={description=Sets players Recover Question + Answer., usage=/<command> [emailaddress]}, 
		// changepassword={description=Changes a player's password., usage=/<command> [oldPassword] [newPassword], aliases=[chpw, cpwd, changepassword, changepass, passchange]}, 
		// recoverpwd={description=recover player's login by sending new password to player's Email-Address or Checking Recover Answer., usage=/<command> [recoveranswer]}
		//}
        
        String Cmddata = StringUtils.substringBetween(Data, Command + "={", "}");
        //login={description=Logs a player in., usage=/<command> [password], aliases=[l, logon, login]},
        
        String Aliasdata = StringUtils.substringBetween(Cmddata, "aliases=[", "]");
        //l, logon, login
