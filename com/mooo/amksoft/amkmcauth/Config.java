...
public class Config {
    ...
    public static boolean godModeGraceLogin;    
    ...
    public void reloadConfiguration() {
        ...
        godModeGraceLogin	= GetSetting(c,"login.godmode.grace_login.enabled"	,true);        
        ...
        this.plugin.getLogger().info("Default Password-Encryption: " + passwordHashType + ".");
